...
export default function Cart() {
    ...
    return <>
        <section id='cart' className='container pb-3 position-relative'>
                    ...
                    <div className='position-relative'>
                        <div className='bg-success-subtle p-2 rounded-2 position-fixed w-25'>
                            ...
                            <div className='d-flex justify-content-between border-bottom border-1 pb-2'>
                                ...
                                <h5 className='fs-5'>EGP {totalCartPrice} </h5>
                            </div>
        ...
        <Link to={'/payment'} className='position-fixed bottom-0 w-100 checkoutBtn d-none'>
